...
# That resource will still support GET calls normally through render(), but that
# is usually left unimplemented. Note that it is possible to return deferreds
# from XML-RPC methods. The client, of course, will not get the answer until the
# deferred is triggered.
